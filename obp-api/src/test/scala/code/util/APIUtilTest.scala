...
class APIUtilTest extends FeatureSpec with Matchers with GivenWhenThen with PropsReset {
  ...
  feature(s"test some APIUtil methods") {
    ...
    scenario(s"Test the ${nameOf(APIUtil.extractResourceDocFields _)}") {
      val cases = Seq(
        ("/obp/v3.1.0/banks/gh.29.uk/accounts/gh.29.uk.current-account-12345/owner", ("obp", "v3.1.0", "/banks/gh.29.uk/accounts/gh.29.uk.current-account-12345/owner")),
        ("/obp/v2.0.0/banks/123/accounts/456", ("obp", "v2.0.0", "/banks/123/accounts/456")),
        ("/obp/v4.0.0/", ("obp", "v4.0.0", "/")),
        ("/obp/v3.1.0/banks/gh.29.uk/accounts/gh.29.uk.current-account-12345/owner?param1=value1", ("obp", "v3.1.0", "/banks/gh.29.uk/accounts/gh.29.uk.current-account-12345/owner")),
        ("/obp/v5.1.0", ("obp", "v5.1.0", "/")),
        ("/CNBV9/v1.0.0/atms", ("CNBV9", "v1.0.0", "/atms")),
        ("/berlin-group/v1.3/consents/CONSENTID/status", ("berlin-group", "v1.3", "/consents/CONSENTID/status")),
        ("/BAHRAIN-OBF/v1.0.0/account-access-consents", ("BAHRAIN-OBF", "v1.0.0", "/account-access-consents"))
      )

      for ((url, expected) <- cases) {
        APIUtil.extractResourceDocFields(url) shouldBe expected
      }
    }
  }
